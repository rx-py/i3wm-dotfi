...
alias vu='nmcli con up mullvadVPN'
alias vd='nmcli con down mullvadVPN'
alias img='montage img1.png img2.png img3.png -geometry +0+0 -tile 1x3 result-name.jpg'
...
# ****** journalctl aliases ******
alias jcsc='sudo journalctl -u'             # View log output of a systemd service
alias jcerror='sudo journalctl -p 3 -xb'    # Show error messages from journalctl
alias jcboots='journalctl --list-boots'     # List boots recorded in journal
alias jctlboot='sudo journalctl -b'         # Show log entries related to last boot
alias jcpac='jcsc pacman-updates.service'
alias jcsshd='journalctl _COMM=sshd'
alias jcnm='sudo journalctl -xe NM_CONNECTION=441945cc-6051-419a-bb1a-adeb5d197198 + NM_DEVICE=wlan0'

alias logrotate='sudo logrotate -v /etc/logrotate.conf '
...
alias scactive='sudo systemctl list-units --type=service'
alias sct2='sudo systemctl enable --now t2wifi.service'
alias scenabled='sudo systemctl list-unit-files --state=enabled'
alias scall='systemctl list-units'
...
alias pu='sudo pacman -Sy && pacman -Qu'
